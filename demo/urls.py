...
urlpatterns = [
    ...
    path('conversation/scenarios', views.scenario, name='scenarios'),
    ...
    path('conversation/action', views.trigger_action, name='trigger_action'), # Ending conversation, Regenerating Conversation and other actions.
